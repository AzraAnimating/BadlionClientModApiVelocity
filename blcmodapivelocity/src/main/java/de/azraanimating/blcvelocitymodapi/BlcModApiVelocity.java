package de.azraanimating.blcvelocitymodapi;
...
import de.azraanimating.blcvelocitymodapi.listener.PlayerLoginListener;
...
@Plugin(id = "blc-1", name = "Badlion Client Velocity Api", version = "3.0-compatible", description = "Velocity Version of BLC's Bukkit & Bungee API", authors = {"Badlion", "AzraAnimating"})
